...
#define NGWA_MODE7 7
#define NGWA_MODE8 8
#define NGWA_MODE9 9 // neural network test
#define NGWA_MODE10 10 // mm01
#define NGWA_MODE11 11 // mm01dpf
#define NGWA_MODE12 12 
#define NGWA_MODE13 13
...
GlobalValue g_UseNGWA  = GlobalValue ("UseNgwa",
                                      ...
                                      MakeEnumChecker (NGWA_MODE0, "off", NGWA_MODE1, "#1",
                                                       ...
                                                       NGWA_MODE7, "#7", NGWA_MODE8, "#8", NGWA_MODE9, "#9",
                                                       NGWA_MODE10, "#10", NGWA_MODE11, "#11", NGWA_MODE12, "#12",
                                                       NGWA_MODE13, "#13"));
